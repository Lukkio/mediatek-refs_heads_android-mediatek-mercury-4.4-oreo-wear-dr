...
#define MTK_WIRELESS_CHARGER_SUPPORT
...
int wireless_charger_gpio_number   = GPIO63;
...
static void hw_bc11_dump_register(void)
{
 ...
 static kal_uint32 charging_hw_init(void *data)
 {
	...
	mt_set_gpio_mode(wireless_charger_gpio_number, 3); //GPIO_MODE_03??
    mt_set_gpio_dir(wireless_charger_gpio_number, 0);
    mt_set_gpio_pull_select(wireless_charger_gpio_number, 1);
    mt_set_gpio_pull_enable(wireless_charger_gpio_number, 0);
	printk(KERN_ALERT "idtp9220: gpio charger_hw_pmic init code: 1\n");
...
kal_bool charging_type_detection_done(void)
 ...
 static kal_uint32 charging_get_charger_type(void *data)
 {
	...
	printk(KERN_ALERT "idtp9220: code: 2, %d \n",wireless_state);
    if (wireless_state == WIRELESS_CHARGER_EXIST_STATE)
    {
		printk(KERN_ALERT "idtp9220: code: 3\n");
 ...
 static kal_uint32 charging_set_power_off(void *data)
 {
	...
	//Luxios disable wireless ic
	//mt_set_gpio_out(GPIO138, 1);
